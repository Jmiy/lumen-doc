...
$validationCustom = [
    ...
    '30000' => [
        ...
        12 => [
            'custom' => [
                'api_code_msg' => 'このご注文番号は既に登録されています。同じご注文番号はご登録頂けません。',
            ]
        ],
        'default' => [
    ...
    '39001' => '入力された注文番号に該当する注文が存在しません。正しい注文番号が入力されているか、または対象店舗で購入されたかご確認ください。', //订单不存在
    ...
    '39007' => '該当の注文は現在保留中です。お手数ですが注文確定後に再度ご登録ください。', //订单状态pending
    '39008' => "キャンセルされた注文はご登録頂けません。", //订单状态cancel
    '50000' => '', //分享相关.
    '60000' => '', //活动相关.
    ...
    '50002' => "注文が確認され、ギフトが配信されました。 貴重なご意見、ありがとうございます！", //存在返现,不能评星/索评
    '50003' => "この製品レビューは既に投稿済みです。ご投稿頂きありがとうございます！", //已经提交过反馈问题，或者已经提交过Rv，不能再次评星
    ...
    '50007' => "ご注文はまだ完了していません。注文確定後にレビュー投稿をお願いいたします。" //非shipped状态的订单
];
