...
$validationCustom = [
    ...
    '10028' => [
        ...
        3 => [
            'custom' => [
                'api_code_msg' => "Can't sign up repeatedly",
            ],
        ],
        'default' => [
    ...
    '10030' => 'There is already an account with this email address', //hommak账号已经存在
    '20000' => '', //积分相关.
    ...
    '60003' => [
        3 => [
            'custom' => [
                'api_code_msg' => 'Your IP/Account Is Applid.',//当前账号或者ip 已经申请过产品
            ],
        ],
        14 => [
            'custom' => [
        ...
        'default' => [
            'api_code_msg' => 'Your application is still in progress, please wait for the result.',//申请的产品审核中
        ],

    ],
    '60005' => "You've already applied, do not submit repeatedly.", //申请众测成功，不要重复申请
    ...
    '60013' => 'Please select a gift from a supported country to unlock', //当用户申请解锁产品时，判断该用户IP地址是否与产品支持地址一致，若不一致，则在按钮下方提示文案
    '60014' => 'The requested some product does not exist', //批量申请的产品时，某些产品不存在
    '60100' => [
        3 => [
            'custom' => [
                'api_code_msg' => 'Your apply has reached the maximum, please contact customer service manually <support@holife.com>',
            ],
        ],
        14 => [
            'custom' => [
                'api_code_msg' => 'Your apply has reached the maximum, please contact customer service manually <support@hommakstore.com>',
            ],
        ],
        'default' => [
            'api_code_msg' => 'Your apply has reached the maximum, please contact customer service',
        ],
    ...
    '50001' => 'Wait 72 hours to submit again', //用户等72小时以后重新提交,
    '50002' => "Order has been reviewed and gifts have been sent. Appreciate your sharing!", //存在返现,不能评星/索评
    '50003' => "You've already rated this product. Much appreciated!", //已经提交过反馈问题，或者已经提交过Rv，不能再次评星
    ...
    '50007' => "The order hasn't been completed yet, please complete it first." //非shipped状态的订单
];
