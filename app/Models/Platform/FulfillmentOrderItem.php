...
class FulfillmentOrderItem extends Model {
     ...
     * @var string
     */
    protected $table = 'platform_fulfillment_order_items';
    ...
    public function fulfillment() {
        return $this->HasOne(Fulfillment::class, Constant::DB_TABLE_UNIQUE_ID, Constant::DB_TABLE_FULFILLMENT_UNIQUE_ID);
    }
