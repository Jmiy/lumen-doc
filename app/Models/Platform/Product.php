...
class Product extends Model {
     ...
     * @var string
     */
    protected $table = 'platform_products';
    ...
    public function variants() {
        return $this->hasMany(ProductVariant::class, Constant::DB_TABLE_PRODUCT_UNIQUE_ID, Constant::DB_TABLE_UNIQUE_ID);
    }
    ...
    public function images() {
        return $this->hasMany(ProductImage::class, Constant::DB_TABLE_PRODUCT_UNIQUE_ID, Constant::DB_TABLE_UNIQUE_ID);
    }
