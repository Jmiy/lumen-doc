...
class Order extends Model {
    ...
    public function items() {
        return $this->hasMany(OrderItem::class, Constant::DB_TABLE_ORDER_UNIQUE_ID, Constant::DB_TABLE_UNIQUE_ID);
    }
    ...
    public function shipping_address() {
        return $this->HasOne(OrderShippingAddress::class, Constant::DB_TABLE_ORDER_UNIQUE_ID, Constant::DB_TABLE_UNIQUE_ID);
    }
