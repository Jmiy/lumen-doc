...
class SurveyResultItem extends Model {
     ...
     */
    public function survey_result_item_options() {
        return $this->hasMany(SurveyResultItemOption::class, 'result_item_id', 'id');
    }
    ...
    public function survey_item() {
        return $this->hasOne(SurveyItem::class, 'id', 'item_id');
    }
