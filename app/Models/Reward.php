...
class Reward extends Model {
    ...
    public function asins() {
        return $this->hasMany(RewardAsin::class, Constant::DB_TABLE_EXT_ID, Constant::DB_TABLE_PRIMARY);
    }
    ...
    public function categories() {
        return $this->hasMany(RewardCategory::class, 'reward_id', Constant::DB_TABLE_PRIMARY);
    }
    ...
    public function codes() {
        return $this->hasMany(Coupon::class, 'ext_id', Constant::DB_TABLE_PRIMARY);
    }
