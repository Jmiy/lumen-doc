...
class ActivityEmailSet extends Model {
...
//    ];
    ...
    {
        return CustomerInfoService::getModel($this->getStoreId())
            ->hasOne(CustomerInfo::class, Constant::DB_TABLE_CUSTOMER_PRIMARY, Constant::DB_TABLE_CUSTOMER_PRIMARY);
    }
}
