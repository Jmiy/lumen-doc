...
class DictStoreService extends BaseService {
     ...
     * @param string $country 国家
     * @param string $conf_value 配置值
     * @param string $remark  备注
     * @return boolean
     */
    public static function add($storeId, $type, $conf_key, $country, $conf_value, $remark) {

        $data[] = [
            Constant::DB_TABLE_STORE_ID => $storeId,
            Constant::DB_TABLE_TYPE => $type,
            Constant::DB_TABLE_COUNTRY => $country,
            Constant::DB_TABLE_STORE_DICT_KEY => $conf_key,
            Constant::DB_TABLE_STORE_DICT_VALUE => $conf_value,
