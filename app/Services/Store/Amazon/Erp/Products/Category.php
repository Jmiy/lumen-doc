...
class Category extends BaseService {
     ...
     * @return array
     */
    public static function getCategory($storeId = 1, $parameters = []) {
        ...
        $url = static::$storeUrl . '/rpc/category/list'; // /rpc/commodity/list
     ...
     * @return array
     */
    public static function getCategoryData($storeId, $platform, $data) {
        ...
        if ($children) {
            foreach ($children as $childrenData) {
                ...
                $_data = \Illuminate\Support\Arr::collapse([$_data, $_childrenData]);
            }
            return $_data;
        }
