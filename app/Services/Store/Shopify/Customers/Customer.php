...
';
        ...
        $url = static::$schema . static::$storeUrl . "graphql.json";
        $res = static::request($url, $requestData, $username, $password, $requestMethod, $headers);
...
//        }
    ...
    public static function getCustomer($storeId = 2, $createdAtMin = '', $createdAtMax = '', $ids = [], $sinceId = '', $limit = 250, $source = 5, $extData = []) {
        ...
        $url = static::$schema . static::$storeUrl . "customers.json";
    ...
    public static function customerQuery($storeId = 2, $order = '', $query = '', $fields = [], $limit = 1, $source = 5) {
        ...
        $url = static::$schema . static::$storeUrl . "customers/search.json";
        $limit = $limit ? $limit : 1;
        $limit = $limit > 250 ? 250 : $limit;
        $requestData = array_filter([
            'order' => $order ? $order : '',
        ...
        $password = static::$password;
        $requestMethod = 'GET';
        $res = static::request($url, $requestData, $username, $password, $requestMethod);
    ...
    public static function delete($storeId = 1, $customerId = '') {
        ...
        $url = static::$schema . static::$storeUrl . "customers/$customerId.json";
    ...
    public static function getCount($storeId = 1) {
        ...
        $url = static::$schema . static::$storeUrl . "customers/count.json";
    ...
    public static function createCustomer($storeId = 1, $account = '', $password = '', $acceptsMarketing = true, $firstName = '', $lastName = '', $phone = '', $accessToken = '') {
        ...
        static::setConf($storeId);
        $accessToken = $accessToken ? $accessToken : static::$accessToken;
...
//}';
        ...
        $res = static::request(static::$graphqlUrl, $requestData, $username, $password, $requestMethod, $headers);
...
//        }
    ...
    public static function getAccountActivationUrl($storeId = 1, $customerId = '') {
        ...
        $url = static::$schema . static::$storeUrl . 'customers/' . $customerId . '/account_activation_url.json';
...
//        }
    ...
    public static function updateCustomerDetails($storeId, $storeCustomerId, $account, $firstName, $lastName, $phone, $note) {
        ...
        $url = static::$schema . static::$storeUrl . "customers/$storeCustomerId.json";
        $requestData = [
