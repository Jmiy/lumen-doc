...
class Product extends BaseService {
    ...
    public static function getProduct($storeId = 2, $parameters = []) {
        ...
        $url = static::$schema . static::$storeUrl . "products.json";
...
//        ];
//        $res = static::imageRequest(static::$graphqlUrl, $requestData, $resource, $filename, $mimetype, $requestMethod, $headers);
//        return $res;
...
//    }
    ...
    public static function count($storeId = 1, $parameters = []) {
        ...
        $url = static::$schema . static::$storeUrl . "products/count.json";
