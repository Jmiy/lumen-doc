    ...
    public static function addAsins($storeId, $rewardId, $name, $businessType, $records, $requestData) {
        ...
        foreach ($records as $record) {
            ...
            $data = [
                ...
                Constant::DB_TABLE_TYPE => data_get($requestData, Constant::DB_TABLE_TYPE, Constant::PARAMETER_INT_DEFAULT),//礼品类型: 0:其他 1:礼品卡 2:coupon 3:实物 5:积分
            ...
            if ($data[Constant::DB_TABLE_TYPE] == 1) {//如果是礼品卡，就使用
                $data[Constant::DB_TABLE_TYPE_VALUE] = data_get($record, Constant::DB_TABLE_TYPE_VALUE, $data[Constant::DB_TABLE_TYPE_VALUE]);
            }
