...
class CouponService extends BaseService {
     ...
     */
    public static function getRewardCoupon($storeId, $extId, $extType, $customerId, $rewardName = '', $account = '', $extWhere = []) {
        $emailData = [
            Constant::SUBJECT => '订单索评奖励 coupon库存不足',
            Constant::DB_TABLE_CONTENT => '官网：' . $storeId . ' 订单索评奖励 ' . $rewardName . ' coupon 库存不足',
        ];

        return static::getRelatedCoupon($storeId, $extId, $extType, $customerId, $emailData, $account, $extWhere);
    }
