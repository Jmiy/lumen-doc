...
class Builder extends EloquentBuilder {
    ...
    public function getAttributesData(array $values, $dbOperation = 'insert') {
        ...
        $requestMark = app('request')->input(Constant::REQUEST_MARK, '');

        //设置时区
        $storeId = data_get($this->getModel(), 'storeId', 0);
        ...
        switch ($dbOperation) {
            case data_get(static::$dbOperation, 1, null):
                ...
                //insert record public data
                if (defined($modelClass . '::IS_RECORD_PUBLIC_DATA') && $modelClass::IS_RECORD_PUBLIC_DATA) {
                    ...
                    foreach ($publicData as $key => $value) {
                        data_set($values, $key, $value, false);
                    }
                }
