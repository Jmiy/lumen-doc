...
use Illuminate\Database\Eloquent\Concerns\HasRelationships as FrameworkHasRelationships;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Database\Eloquent\Builder;
use App\Database\Eloquent\Relations\MorphTo;

trait HasRelationships {

    use FrameworkHasRelationships;
...
//                        $this->newRelatedInstance($related)->newQuery(), $this, $through, $firstKey, $secondKey, $localKey ?: $this->getKeyName(), $secondLocalKey ?: $through->getKeyName()
//        );
//    }
...
//        return empty($class = $this->{$type}) ? $this->morphEagerTo($name, $type, $id, $ownerKey) : $this->morphInstanceTo($class, $name, $type, $id, $ownerKey);
//    }
...
//                    return !in_array(
//                                    $trace['function'], array_merge(static::$manyMethods, ['guessBelongsToManyRelation'])
//                    );
//                });
//
